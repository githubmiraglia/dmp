...
function runCreateScripts(){
	...
	var interval = setInterval(function(){
		...
		if (checkLoaded(check)){
			...
			s8 = new createScripts("s8",_ROOT+"/actors/base.js");
			s9 = new createScripts("s9",_ROOT+"/actors/bullet.js");
			s10 = new createScripts("s10",_ROOT+"/actors/shield.js");
			s11 = new createScripts("s11",_ROOT+"/actors/splat.js");
			s12 = new createScripts("s12",_ROOT+"/actors/alien.js");
			s13 = new createScripts("s13",_ROOT+"/actors/bomb.js");
			s14 = new createScripts("s14",_ROOT+"/actors/saucer.js");
			...
			var interval_3 = setInterval(function(){
				var check=["s3","s4","s5","s6","s7","s8","s9","s10","s11","s12","s13","s14","s15","s16","s17","s18"];
				if(checkLoaded(check)){
